...
class PublicSiteStaticTests(unittest.TestCase):
    ...
    def test_homepage_is_mainnet_product(self) -> None:
        ...
        self.assertIn("https://additionblockchain.com/banners/addition-banner-1.mp4", index)
        self.assertIn("https://additionblockchain.com/banners/addition-banner-2.mp4", index)
