...
inline constexpr const char* kHygieneReceiptPrefix = "ADDITION-HYGIENE-REHEARSAL|v1|";
inline constexpr const char* kHygieneMovesBitcoin = "0";
inline constexpr const char* kHygieneClaim = "attestation_not_bip360";
