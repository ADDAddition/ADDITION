...
- `/download/` is the testnet / local wallet binary page (Linux files plus `addition-wallet-testnet.exe` / `addition-wallet-cli-testnet.exe`). Windows binaries land in `web/public/download/`. No hosted web wallet.
